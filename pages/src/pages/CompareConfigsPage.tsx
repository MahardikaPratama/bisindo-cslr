...
export default function CompareConfigsPage() {
  ...
  const renderComparisonTable = (title: string, testA: any, testB: any) => {
    ...
    return (
      <div className="bg-surface-card border border-surface-border rounded-2xl overflow-x-auto shadow-panel mb-8">
  ...
  return (
    <div className="pt-24 pb-20 px-6 w-full max-w-screen-xl mx-auto flex flex-col min-h-screen overflow-x-hidden">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
        ...
        <div className="flex flex-col md:flex-row items-center gap-4 bg-surface-card p-4 rounded-xl border border-surface-border shadow-sm w-full md:w-auto">
          <div className="flex flex-col w-full md:w-auto">
            <label className="text-xs font-semibold text-brand-blue mb-1 uppercase tracking-wider">Base (A)</label>
            <ConfigDropdown
              value={configA}
              onChange={setConfigA}
              buttonClassName="border-brand-blue/30 focus:ring-brand-blue focus:border-brand-blue w-full"
              activeItemClassName="text-brand-blue"
            />
          </div>

          <div className="flex items-center justify-center text-text-muted md:mt-5">
          ...
          <div className="flex flex-col w-full md:w-auto">
            ...
            <ConfigDropdown
              value={configB}
              onChange={setConfigB}
              buttonClassName="border-purple-500/30 focus:ring-purple-400 focus:border-purple-400 w-full"
